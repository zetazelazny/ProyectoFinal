...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Registro en el sitio - Integrapp</title>
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    if(isset($_SESSION['usuario']))
                    {
                        echo '<li class="submenu-item"><a href="perfil">Perfil</a></li>';
                        echo '<li class="submenu-item"><a href="cerrarsesion.php">Salir</a></li>';
                    }
                    else
                    {
                        echo '<li class="submenu-item"><a href="/registro">Registro</a></li>';
                        echo '<li class="submenu-item"><a href="login">Ingreso</a></li>';
                    }
                    ?>
...
<fieldset>
        ...
        <label for="nummat">Número de matrícula (dejar vacío en caso de no tener):</label>
        <input type="text" name="nummat" id="nummat">
